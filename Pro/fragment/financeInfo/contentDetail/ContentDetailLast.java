...
import com.helloants.helloants.adapters.viewholder.ImgListViewHolder;
...
public class ContentDetailLast extends Fragment implements AdapterView.OnItemClickListener {
    ...
    private void initData() {
        ...
        for(int i=0;i<6;i++){
            ...
            Log.v("라스트", String.valueOf(mAllContentList.get((int) randomList.get(i)).mFilePath));
        }
                ...
                new ViewTreeObserver.OnGlobalLayoutListener() {
                    ...
                    public void onGlobalLayout() {
                        ...
                        if (numColumns > 0) {
                            ...
                            Log.v("길이", String.valueOf(columnWidth));
                            Log.v("길이", String.valueOf(grid.getWidth()));
    ...
    private class ImageAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup container) {
            ...
            if (convertView == null) {
                ...
                parm = new FrameLayout.LayoutParams(700,700); //////////////// 표시 길이 조정
