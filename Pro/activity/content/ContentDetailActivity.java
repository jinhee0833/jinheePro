package com.helloants.helloants.activity.content;
...
import com.helloants.helloants.adapters.ApplicationAdapter;
import com.helloants.helloants.data.DeviceSize;
import com.helloants.helloants.data.constant.AreaType;
...
import com.helloants.helloants.fragment.financeInfo.contentDetail.ContentDetailFragment;
import com.helloants.helloants.fragment.financeInfo.contentDetail.ContentDetailLast;
import com.helloants.helloants.fragment.financeInfo.contentDetail.Gallery;
import com.helloants.helloants.fragment.financeInfo.reply.SlidingListFragment;
...
import com.helloants.helloants.util.ImageCache;
...
public class ContentDetailActivity extends FragmentActivity implements View.OnClickListener {
    ...
    private void cache() {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN) {
            mPager.setBackground(new BitmapDrawable(getResources(), blurredBitmap));
        }
                    ...
                    try {
                        if (LoginData.mEmail.equals("")) {
                            ...
                            if (ScrapDB.INSTANCE.isScrap(mID)) {
                                ...
                                scrapText.setTextColor(Color.GRAY);
                                        ...
                                        .setPositiveButton("확인", new DialogInterface.OnClickListener() {
                                            ...
                                            public void onClick(DialogInterface dialog, int which) {
                                                ...
                                                if (ScrapDB.INSTANCE.isDuplicate(name)) {
                                                    ...
                                                    scrapText.setTextColor(Color.BLUE);
    ...
    private void initLikeBtn() {
        if (ContentDB.INSTANCE.isLike(mID)) likeText.setTextColor(Color.RED);
        else likeText.setTextColor(Color.GRAY);
        if (ScrapDB.INSTANCE.isScrap(mID)) scrapText.setTextColor(Color.BLUE);
        else scrapText.setTextColor(Color.GRAY);
    ...
    private class ImagePagerAdapter extends FragmentStatePagerAdapter {
        ...
        public android.support.v4.app.Fragment getItem(int position) {
            if(mSize-position == 1){
                ...
                return ContentDetailFragment.newInstance(mContentList.get(position).mFilePath);
            }
        }
    }
